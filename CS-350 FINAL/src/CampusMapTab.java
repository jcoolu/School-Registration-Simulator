...
public class CampusMapTab extends JPanel {
	private String[] buildings = { "Adams Library", "ALEX AND ANI HALLL", "Alger Hall", "Art Center",
			...
			"Building 3 - Financial Aid/Classrooms/Cafe", "Building 4 - Bursar/Records",
			"Building 5 - Accounting/Payroll/Purchasing", "Building 6 - Human Resources/Upward Bound",
			"Building 8 - Outreach Programs", "Building 26 - Student-Athlete Success Center",
			"Building 27 - Storage Building", "Building 30 - English Department/Offices", "Clarke Science Building",
			"Cooperative Preschool", "Craig-Lee Hall", "Donovan Dining Center", "Faculty Center",
			"Fogarty Center - Admissions", "Forman Center - Admissions", "Gaige Hall", "Guardo Hall",
			"Henry Barnard Laboratory School", "Horace Mann Hall", "Kauffman Center", "Keefe Transportation Center",
			"The Murray Center", "Nazarian Center for the Performing Arts", "Penfield Residence Hall",
			"Physical Plant Building", "President's House", "Recreation Center", "Roberts Hall",
			"Sherlock Center on Disabilities", "Student Union", "Sweet Residence Hall", "Thorp Residence Hall",
			"Weber Residence Hall", "Welcome Center", "Whipple Hall", "Willard Residence Hall", "Yellow Cottage" };
	...
	public CampusMapTab() {
		...
		CampusMapTab.addButton(president, 62, 469,
				"<b><u><font size=\"5\">President's House</b></u></font><br><br>"
						+ "President<br>Frank S�nchez<br>President@ric.edu<br><br><b><font size=\"4\">Contact Info: </b><br></font>"
